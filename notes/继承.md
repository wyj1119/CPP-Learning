...
![image-20251207155055832](C:\data_structure_L\CPP\inheritance.png)
...
![image-20251207163308565](C:\data_structure_L\CPP\菱形继承.png)

两个派生类继承同一个基类，又有另外一个类继承这两个派生类。

![image-20251207163613225](C:\data_structure_L\CPP\菱形继承案例.png)
