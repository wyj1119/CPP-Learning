...
* 浅拷贝：简单的赋值拷贝操作
  ...
  ![image-20251205160814340](C:\CPP_Learning\figures\shallow_copy.png)
...
![image-20251207155055832](C:\CPP_Learning\figures\inheritance.png)
...
![image-20251207163308565](C:\CPP_Learning\figures\菱形继承.png)

两个派生类继承同一个基类，又有另外一个类继承这两个派生类。

![image-20251207163613225](C:\CPP_Learning\figures\菱形继承案例.png)
